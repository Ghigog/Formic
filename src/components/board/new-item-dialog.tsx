...
/**
 * Raw request capture: a feature or a bug, in the person's own words. This is stage 1 of the lifecycle: whatever is
...
export function NewItemDialog({
  ...
  async function submit() {
    if (value.trim().length < 3) {
      setError("Describe the feature or bug in a sentence or two.");
      ref.current?.animate?.(
